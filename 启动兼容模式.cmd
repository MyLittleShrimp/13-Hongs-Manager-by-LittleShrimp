...
start "" "%~dp0tools\godot\Godot_v4.7.2-stable_win64.exe" --path "%~dp0prototype" --rendering-method gl_compatibility --max-fps 30 --log-file "%~dp0artifacts\compatibility.log" -- --compatibility
endlocal
